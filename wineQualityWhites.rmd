White Wine Exploratory Analysis by Praxitelis-Nikolaos Kouroupetroglou
==========================================================================
---------
...
p1 <- ggplot(wine, aes_string(x = 'chlorides')) +
    geom_histogram(bins=30, binwidth = 0.01, col="red", aes(fill=..count..)) + xlab("Chlorides (g/dm^3)")+
...
p1 <- ggplot(data = wine, aes(x = wine$chlorides.log)) + geom_histogram(col="red", aes(fill=..count..)) + 
...
p1 <- ggplot(wine, aes_string(x = 'sulphates')) +
    geom_histogram(col="red", aes(fill=..count..)) + xlab("Sulphates (g/dm^3)")+
...
ggplot(data= wine, aes(x = pH, y = fixed.acidity)) + geom_jitter(height = 0, alpha=0.08) +
  geom_smooth(method='lm',color = 'blue',linetype=2) +
  xlim(min(wine$pH), max(wine$pH)) +
  ylim(min(wine$fixed.acidity), max(wine$fixed.acidity)) +
...
ggplot(data= wine, aes(x = density, y = residual.sugar.log)) + geom_jitter(height = 0, alpha=0.08) +
  geom_smooth(method='lm',color = 'blue',linetype=2) +
  xlim(min(wine$density), max(wine$density)) +
  ylim(min(wine$residual.sugar.log), max(wine$residual.sugar.log)) +
  ggtitle('density and residual.sugar scatterplot')
```
...
ggplot(data= wine, aes(x = alcohol, y = residual.sugar.log)) + geom_jitter(height = 0, alpha=0.08) +
  geom_smooth(method='lm',color = 'blue',linetype=2) +
  xlim(min(wine$alcohol), max(wine$alcohol)) +
  ylim(min(wine$residual.sugar), max(wine$residual.sugar.log)) +
  ggtitle('alcohol and residual.sugar scatterplot')
```
...
ggplot(data= wine, aes(x = alcohol, y = total.sulfur.dioxide)) + geom_jitter(height = 0, alpha=0.08) +
  geom_smooth(method='lm',color = 'blue',linetype=2) +
  xlim(min(wine$alcohol), max(wine$alcohol)) +
  ylim(min(wine$total.sulfur.dioxide), max(wine$total.sulfur.dioxide)) +
  ggtitle('alcohol and total.sulfur.dioxide scatterplot')
```
The alcohol - total.sulfur.dioxide scatterplot shows a strong negative correlation (-0.45 pearson)

```{r echo=FALSE, warning=FALSE, Bivariate_Plots13}
ggplot(data= wine, aes(x = density, y = total.sulfur.dioxide)) + geom_jitter(height = 0, alpha=0.08) +
  geom_smooth(method='lm',color = 'blue',linetype=2) +
  xlim(min(wine$density), max(wine$density)) +
  ylim(min(wine$total.sulfur.dioxide), max(wine$total.sulfur.dioxide)) +
...
ggplot(data= wine, aes(x = free.sulfur.dioxide, y = total.sulfur.dioxide)) + 
  geom_jitter(height = 0, alpha=0.08) +
  geom_smooth(method='lm',color = 'blue',linetype=2) +
  xlim(min(wine$free.sulfur.dioxide), max(wine$free.sulfur.dioxide)) +
  ylim(min(wine$total.sulfur.dioxide), max(wine$total.sulfur.dioxide)) +
...
ggplot(data= wine, aes(x = total.sulfur.dioxide, y = residual.sugar.log)) + 
  geom_jitter(height = 0, alpha=0.08) +
  geom_smooth(method='lm',color = 'blue',linetype=2) +
  xlim(min(wine$total.sulfur.dioxide), max(wine$total.sulfur.dioxide)) +
  ylim(min(wine$residual.sugar.log), max(wine$residual.sugar.log)) +
  ggtitle('total.sulfur.dioxide and residual.sugar.log scatterplot')
```
...
ggplot(data= wine, aes(x = alcohol, y = chlorides.log)) + 
  ...
  geom_smooth(method='lm',color = 'blue',linetype=2) +
  xlim(min(wine$alcohol), max(wine$alcohol)) +
  ylim(min(wine$chlorides.log), max(wine$chlorides.log)) +
...
ggplot(wine, aes(x = pH, y = fixed.acidity, color = as.factor(quality))) +
  geom_point() +
  geom_smooth(method='lm',color = 'blue',linetype=2)  +
  xlim(min(wine$pH), max(wine$pH)) +
  ylim(min(wine$fixed.acidity), max(wine$fixed.acidity)) +
...
ggplot(wine, aes(x = alcohol, y = residual.sugar.log, color = as.factor(quality))) +
  geom_point() +
  geom_smooth(method='lm',color = 'blue',linetype=2)  +
  xlim(min(wine$alcohol), max(wine$alcohol)) +
  ylim(min(wine$residual.sugar.log), max(wine$residual.sugar.log)) +
...
ggplot(wine, aes(x = alcohol, y = total.sulfur.dioxide, color = as.factor(quality))) +
  geom_point() +
  geom_smooth(method='lm',color = 'blue',linetype=2)  +
  xlim(min(wine$alcohol), max(wine$alcohol)) +
  ylim(min(wine$total.sulfur.dioxide), max(wine$total.sulfur.dioxide)) +
...
ggplot(wine, aes(x = density, y = total.sulfur.dioxide, color = as.factor(quality))) +
  geom_point() +
  geom_smooth(method='lm',color = 'blue',linetype=2)  +
  xlim(min(wine$density), max(wine$density)) +
  ylim(min(wine$total.sulfur.dioxide), max(wine$total.sulfur.dioxide)) +
...
ggplot(wine, aes(x = free.sulfur.dioxide, y = total.sulfur.dioxide, color = as.factor(quality))) +
  geom_point() +
  geom_smooth(method='lm',color = 'blue',linetype=2)  +
  xlim(min(wine$free.sulfur.dioxide), max(wine$free.sulfur.dioxide)) +
  ylim(min(wine$total.sulfur.dioxide), max(wine$total.sulfur.dioxide)) +
...
ggplot(wine, aes(x = total.sulfur.dioxide, y = residual.sugar.log, color = as.factor(quality))) +
  geom_point() +
  geom_smooth(method='lm',color = 'blue',linetype=2)  +
  xlim(min(wine$total.sulfur.dioxide), max(wine$total.sulfur.dioxide)) +
  ylim(min(wine$residual.sugar.log), max(wine$residual.sugar.log)) +
...
ggplot(wine, aes(x = alcohol, y = chlorides.log, color = as.factor(quality))) +
  geom_point() +
  geom_smooth(method='lm',color = 'blue',linetype=2)  +
  xlim(min(wine$alcohol), max(wine$alcohol)) +
  ylim(min(wine$chlorides.log), max(wine$chlorides.log)) +
...
```{r echo=FALSE, warning=FALSE, Building_Linear_Model}
