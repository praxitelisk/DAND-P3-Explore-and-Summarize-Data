...
p1 <- ggplot(wine, aes_string(x = 'volatile.acidity')) +
    geom_histogram(bins=35, col="red", fill="#4a85e8") + 
...
p1 <- ggplot(wine, aes(x = citric.acid)) +
    geom_histogram(bins=35, col="red", fill="#4a85e8") + xlab("Citric Acid (g/dm^3)") +
...
p1 <- ggplot(wine, aes_string(x = 'residual.sugar')) +
    geom_histogram(bins=25, binwidth = 1.5, col="red", fill="#4a85e8") + xlab("Residual Sugar (g/dm^3)") +
...
p1 <- ggplot(data = wine, aes(x=wine$residual.sugar.log)) + 
  geom_histogram(binwidth = 0.065, col="red", fill="#4a85e8") + labs(title="Log transformed Residual Sugar distribution") +
...
p1 <- ggplot(wine, aes_string(x = 'chlorides')) +
    geom_histogram(bins=33, binwidth = 0.008, col="red", fill="#4a85e8") + xlab("Chlorides (g/dm^3)")+
...
p1 <- ggplot(data = wine, aes(x = wine$chlorides.log)) + 
  geom_histogram(binwidth = 0.06, col="red", fill="#4a85e8") + 
...
p1 <- ggplot(wine, aes_string(x = 'free.sulfur.dioxide')) +
    geom_histogram(bins=32, binwidth = 8, col="red", fill="#4a85e8") + xlab("Free Sulfur Dioxide (mg/dm^3)")+
...
p1 <- ggplot(wine, aes_string(x = 'total.sulfur.dioxide')) +
    geom_histogram(bins = 35,col="red", fill="#4a85e8") + xlab("Total Sulfur Dioxide (mg/dm^3)")+
...
p1 <- ggplot(wine, aes_string(x = 'density')) +
    geom_histogram(bins=32, col="red", fill="#4a85e8") + xlab("Density (g/cm^3)")+
...
p1 <- ggplot(wine, aes_string(x = 'pH')) +
    geom_histogram(col="red", fill="#4a85e8") + xlab("pH")+
...
p1 <- ggplot(wine, aes_string(x = 'sulphates')) +
    geom_histogram(binwidth = 0.017, col="red", fill="#4a85e8") + xlab("Sulphates (g/dm^3)")+
...
p1 <- ggplot(wine, aes_string(x = 'alcohol')) +
    geom_histogram(bins= 73, col="red", fill="#4a85e8") + xlab("Alcohol (% by Volume)")+
...
ggplot(wine, aes(factor(quality), alcohol)) +
  ...
  ggtitle('quality and alcohol Relations') + scale_fill_brewer(palette = "RdYlBu") + theme_dark() +
...
ggplot(wine, aes(factor(quality), chlorides.log)) +
  ...
  labs(color='Quality')  +
  xlab("quality (score between 0 and 10)") +
  ylab("chlorides log transformed (sodium chloride - g / dm^3)") + 
